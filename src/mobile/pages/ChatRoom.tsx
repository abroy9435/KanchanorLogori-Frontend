        ...
        <div className="flex items-center justify-between px-[1rem] h-full">
          <div className="flex items-center gap-[0.75rem] min-w-0">
            ...
            <div className="flex flex-col min-w-0">
              <span className="font-[semibold] truncate leading-[1.2]">{partner?.name || "Loading..."}</span>
              {/* department instead of 'online' */}
              {partner?.department ? (
...
//           uid: partnerUid,
//           name: data?.name || "User",
//           avataar: data?.avataar || "/profile_placeholder.jpg",
//           department: data?.department_name || "", // <- show in banner
//         });
//       } catch {
//         setPartner({
...
//               {/* department instead of 'online' */}
//               {partner?.department ? (
//                 <span className="text-[0.8rem] text-white/70 truncate">
//                   {partner.department}
//                 </span>
//               ) : (
//                 <span className="text-[0.8rem] text-white/40">Loading...</span>
...
//           <button className="text-white/80 rounded-[2.5rem] py-[0.2rem] bg-[#82817c]/50 border-none hover:text-white">
//             <MoreVertical className="w-[1.5rem] h-[1.5rem]" />
//           </button>
//         </div>
//       </div>
