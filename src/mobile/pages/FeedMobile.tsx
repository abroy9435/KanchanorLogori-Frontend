...
// import { getRandomProfiles, setLike, setBlock, setUnblock } from "../../shared/api"; // ⬅️ added imports
...
//   // - swiping RIGHT → previous profile
//   // - swiping LEFT → do nothing (snap back)
//   // ---------------------------
...
//                   <h2 className="text-[1.8rem] font-bold leading-tight">{profile.name}</h2>
...
//               }}
//             >
//               <div className="bg-[#121212] rounded-t-[1.25rem] px-[1rem] pt-[0.75rem] pb-[1rem]">
//                 {/* grabber */}
//                 <div className="mx-auto mb-[0.6rem] h-[0.3rem] w-[2.5rem] rounded-full bg-white/20" />
//                 <button
//                   className="w-full text-left text-[1.05rem] py-[0.9rem] text-white"
//                   onClick={() => {
//                     setSheetOpen(false);
//                     setModal(profile.has_blocked ? "unblock" : "block"); // ⬅️ dynamic
//                   }}
//                 >
...
//       {/* ===== Center Modal: Block / Unblock + existing report placeholder ===== */}
//       <AnimatePresence>
//         {modal && (
//           <>
//             <motion.button
...
//               onClick={() => (relationBusy ? null : setModal(null))}
...
//               {modal === "report" ? (
//                 <>
//                   <h3 className="text-[1.25rem] font-semibold mb-[0.4rem]">Report account</h3>
//                   <p className="text-white/80 text-[0.95rem] mb-[0.9rem]">
//                     This is a placeholder dialog. You said you’ll design the final popup later.
//                   </p>
//                   <div className="flex justify-end gap-[0.6rem]">
//                     <button
//                       className="px-[0.9rem] py-[0.5rem] rounded-[0.6rem] bg-white/10"
//                       onClick={() => setModal(null)}
//                     >
//                       Cancel
//                     </button>
//                     <button
//                       className="px-[0.9rem] py-[0.5rem] rounded-[0.6rem] bg-[#FF5069] text-black"
//                       onClick={() => setModal(null)}
//                     >
//                       OK
//                     </button>
...
//                     </p>
//                   )}
//                   <div className="flex flex-col justify-center item-center gap-[0.6rem]">

//                     {modal === "block" ? (
//                       <button
//                         className="px-[0.9rem] py-[0.5rem] rounded-[0.6rem] border-none bg-[#FF5069] text-black disabled:opacity-60"
...
//                     <button
//                       className="px-[0.9rem] py-[0.5rem] mt-[0.75rem] border-none rounded-[0.6rem] bg-white/10 disabled:opacity-60"
//                       onClick={() => setModal(null)}
//                       disabled={relationBusy}
//                     >
//                       Cancel
